 ...
 * @author mittr
 */
public class PhForgot extends javax.swing.JFrame {
        
    String id, ans;
    /**
     * Creates new form PhForgot
     */
    public PhForgot() {
    ...
    private void initComponents() {
        ...
        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Hospital/back1.png"))); // NOI18N
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Hospital/Forgot.jpg"))); // NOI18N
        jLabel1.setText("\n");
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1120, 510));
    ...
    private void submitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitActionPerformed
        try {
            ...
            PreparedStatement ps = c.con.prepareStatement("SELECT username, recovery, id FROM pharmacists");
    ...
    private void submitKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_submitKeyPressed
        if(evt.getKeyCode()== KeyEvent.VK_ENTER){
            try {
                ...
                PreparedStatement ps = c.con.prepareStatement("SELECT username, recovery FROM pharmacists");
                ResultSet rs = ps.executeQuery();
    ...
    private void submit1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submit1ActionPerformed
        ...
        try{
            ...
            PreparedStatement ps = c1.con.prepareStatement("SELECT ans from pharmacists WHERE id ="+id+";");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            if(ss.equals(sss)){
                Connect c = new Connect();
                PreparedStatement ps = c.con.prepareStatement("UPDATE pharmacists SET password = '"+ss+"' WHERE id = "+id+" ");
                ps.executeUpdate();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PhForgot.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
